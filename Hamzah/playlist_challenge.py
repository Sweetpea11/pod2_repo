...
playlist_functions.display_playlist(my_playlist)
...
playlist_functions.add_song(my_playlist, {'artist': 'Frank Ocean', 'title': 'Pyramids'})
...
playlist_functions.display_playlist(my_playlist)
print(type(range(len(my_playlist))))
print(range(len(my_playlist)))

# 5 Add 2 more songs to my_playlist, then display it again using the display_playlist() function
print('Question 5')

playlist_functions.add_song(my_playlist, {'artist': 'Lauryn Hill', 'title': 'Everything is Everything'})
playlist_functions.add_song(my_playlist, {'artist': 'Lupe Fiasco', 'title': 'Murals'})
...
num_track = playlist_functions.get_playlist_length(my_playlist)
print(f'Your playlist has {num_track} songs')
