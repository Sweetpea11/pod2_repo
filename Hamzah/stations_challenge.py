...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'Subway lines {self.lines} stop at {self.station_name} station and is located at {self.location}')
...
lines: ['1', '2', '3', 'L']
'''
sub_station = SubwayStation(station_name = '14th street', location = '14th street and 7th avenue', lines = ['1', '2', '3', 'L'])
...
class BusStation(Station):
    ...
    def open_station(self):
        self.open = True
        print(f'{self.station_name} station is open!')

    def close_station(self):
        self.open = False
        print(f'{self.station_name} station is closed!')

    def show_info(self):
        print(f'{self.station_name} station is located at {self.location}')
        print(f'From {self.station_name} station located at {self.location} you can ride on routes {self.routes}')
        if self.open == True:
