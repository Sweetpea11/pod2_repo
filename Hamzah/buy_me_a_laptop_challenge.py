...
print(f'All laptops names:{all_laptops}')
...
# laptops[0]["types"][0]["storage"].pop... # There is not a 1 TB option for the MacBook Pro 13". I will solve for the MBP 16" which has a 1 TB option
...
print(f'The prices for the MacBook Pro 13" are {laptops[0]["types"][0]["price"]};\nThe prices for the MacBook Pro 16" are {laptops[0]["types"][1]["price"]}')

print(f'The prices for the Dell XPS 13" are {laptops[1]["types"][0]["price"]}; \nThe prices for the Dell XPS 15" are {laptops[1]["types"][1]["price"]}')
