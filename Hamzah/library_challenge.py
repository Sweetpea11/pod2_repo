...
print(type(books))
print('The data type is a list of string because of the bracket ([]) and strings inside')
...
print('It is a list of dictionaries with a key-value pair')
...
def count_books():
    return len(books_with_details) # len will only give you an integer

# 2.2
# Check the number of books available in the books list using the count_books function

print(count_books()) # print is needed to get an output
