...
my_library.add('Hello', 'Brian Stern')
...
print(f'the number of books in my library is {my_library.count_books()}')
...
nyt_bestsellers.add('The Jailhouse lawyer', 'James Patterson')
nyt_bestsellers.add('The Man Who Died Twice', 'Richard Osman')
