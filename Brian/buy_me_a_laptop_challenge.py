...
# Going to try to do a loop since I already watched some of the loop videos
...
print(f'The prices of the 16" MacBook Pro are: {laptops[0]["types"][1]["price"]}')

# TODO: Write code to print all the color options for Dell XPS 13.

print()
print(f'The color options for the Dell XPS 13 are {laptops[1]["types"][0]["colors"]}')
print()

# TODO: Write code to print the description of Dell XPS laptop.
print(f'Here is the description of the Dell XPS laptop: {laptops[1]["description"]}')
print()
...
print()
print(f'This is a list of the possible prices for the 13" Macbook Pro {laptops[0]["types"][0]["price"]}')
print()
