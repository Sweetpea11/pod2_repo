...
add_song(my_playlist, {'artist': 'U2', 'title': 'Beautiful Day'})
print()
...
add_song(my_playlist, {'artist': 'Billie Eilish', 'title': 'Bad Guy'})
add_song(my_playlist, {'artist': 'Michael Jackson', 'title': 'Thriller'})
display_playlist(my_playlist)
print()
