...
print(f"The value of c ({c}) is True since a ({a}) is eqaul to b ({b}).")
...
print('d is set to False because 5 is not greater than 7 and 8 is less than 20, but we are using the not statement making it also False')
...
print (f"The value of o ({o}) is True since I changed the operator to the not equal to sign thus making it True.")
