...
print('Books is a list because it is surrounded by brackets.  I\'m also going to print type the object which should output list')
print(type(books))
print()
...
print('This is a list with 16 dictionaries embeded in the list')
print()
# 2.1
...
def search_by_author(author):
    ...
    for book in books_with_details:
        if book['author'] == author:
            authored_books.append(book['title'])
