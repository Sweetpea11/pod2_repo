...
class SubwayStation(Station):
    ...
    def show_info(self):
         print(f'{self.station_name} station is located at {self.location} and the {self.lines} lines stop there.')
...
class BusStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and the {self.routes} routes stop there.')
        if self.open == True:
            print(f'The bus station is open')
        else:
            print(f'The bus station is closed')
...
lines: ['1', '2', '3', 'L']
'''
station1 = SubwayStation(station_name='14th street', location='14th street and 7th avenue', lines=['1', '2', '3', '4'])
station1.show_info()
