...
lines: ['1', '2', '3', 'L']
'''
random_station = SubwayStation(station_name = '14th street', location = '14th street and 7th avenue', lines = ['1', '2', '3', 'l'])
...
'''
the_loop = BusStation(station_name = 'NYC Megabus Stop', location = '34th street and 12th avenue', lines = ['Boston', 'DC', 'Philly'])
the_loop.show_info()
