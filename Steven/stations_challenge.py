...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and, from this station, you can take the following subway lines: {self.lines}')
...
s1 = SubwayStation(station_name = '14th street', location = '14th street and 7th avenue', lines = '1, 2, 3, L')
s1.show_info()
...
class BusStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and, from this station, you can take a bus to the following places: {self.routes}.')
        if self.open:
            print('Open')
        else:
            print('Closed')
...
b1 = BusStation(station_name = 'NYC Megabus Stop', location = '34th street and 12th avenue', routes = ['Boston', 'DC', 'Philly'])
b1.show_info()
b1.close_station()
b1.open_station()
b1.show_info()
