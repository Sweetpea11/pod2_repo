...
print(f"In the 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made / jamal_murray_3pts_attempts} percent of 3-point attempts.") 

# TODO: Calculate and print the 3 point percentage for Fred VanVleet
print(f"In the 2020 NBA playoffs, Fred VanVleet made {fred_vanvleet_3pts_made / fred_vanvleet_3pts_attempts} percent of 3-point attempts.")

# TODO: Calculate and print the 3 point percentage for James Harden
print(f"In the 2020 NBA playoffs, James Harden made {james_harden_3pts_made / james_harden_3pts_attempts} percent of 3-point attempts.")
...
print(f"{lakers_are_best}: The Lakers are the best NBA team.")
