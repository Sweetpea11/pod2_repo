...
# 'artist' (string)
# 'title' (string)
add_song(my_playlist,{'artist': 'meek mills', 'title': 'wins and losses'})
'''
...
add_song(my_playlist,{'artist': 'meek mills', 'title': 'dreams and nightmares'})
add_song(my_playlist,{'artist': 'meek mills', 'title': 'champions'})
print(my_playlist)
