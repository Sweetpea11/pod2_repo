...
add_song(my_playlist, {'artist': 'Mariah Carey', 'title': 'Hero'})
...
add_song(my_playlist, {'artist': 'Beyonce', 'title': 'I Miss You'})
add_song(my_playlist, {'artist': 'Jay Z', 'title': 'Beach Is Better'})
